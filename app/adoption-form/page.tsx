            ...
            <div className="bg-white rounded-xl border-orange-400 shadow-lg p-10 h-full">
              <div className="max-w-3xl text-center">
                ...
                <p className="text-lg leading-relaxed mb-4 text-gray-700">
                  At Pawdopt, we are a local organization dedicated to finding
                  loving homes for animals in need. Our adoption process is
                  straightforward and designed to ensure a good match between
                ...
                <ul className="list-disc list-inside mb-4 text-left text-lg leading-relaxed text-gray-700">
                  ...
                  <li>
                    Receive an email confirmation indicating that your
                    application has been received.
                  </li>
                  <li>Our team will evaluate your application.</li>
                  <li>We will get back to you within one week.</li>
                  <li>
                    If approved, you can arrange a meet-and-greet with your
                    potential pet!
                  </li>
                </ul>
                <p className="text-lg leading-relaxed mb-4 text-gray-700">
                  If you have any questions or need further assistance, feel
                  free to reach out. Your journey to adopting a new furry friend
                  begins with us!
                </p>
                <h2 className="text-2xl font-semibold text-orange-400 mb-4">
                  Why Choose Adoption?
                ...
                <p className="text-lg leading-relaxed mb-4 text-gray-700">
                  Adopting a pet not only gives a loving animal a second chance
                  but also enriches your life with companionship and joy. All of
                  our animals are evaluated for health and temperament, ensuring
                  a good fit for your family.
                </p>
                <p className="text-lg leading-relaxed text-gray-700">
                  Thank you for considering adoption! Together, we can make a
